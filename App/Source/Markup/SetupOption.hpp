...
{
	Vector3f Color = Vector3f(0.2,0.2,0.2);
...
public:
	...
	optionButton->BorderRadius = 2;
	optionButton->BorderSizeMode = KlemmUI::UIBox::SizeMode::PixelRelative;
	optionButton->BorderColor = Vector3f(0.6,0.1,0.1);
	optionButton->SetMinSize(Vector2f(250,450));
	...
	e_2->SetColor(Vector3f(0.05));
	e_2->SetMinSize(Vector2f(250,175));
	e_2->SetMaxSize(Vector2f(250,175));
