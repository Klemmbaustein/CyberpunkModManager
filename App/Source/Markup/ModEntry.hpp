...
public:
	...
	imageBackground->SetColor(Vector3f(0.05));
	imageBackground->SetMinSize(Vector2f(196,112));
	imageBackground->SetMaxSize(Vector2f(196,112));
	...
	imageBackground->SetPadding((float)2);
	...
	imageText->SetColor(Vector3f(1));
	imageText->SetTextSize(15);
	...
	e_4->SetMinSize(Vector2f(200,180));
	e_4->SetMaxSize(Vector2f(200,180));
	...
	infoText->SetColor(Vector3f(0.7));
